...
public class Diciplina {
	...
	private List<MatriculaDiciplinaPessoa> matriculaDiciplinaPessoas = new ArrayList<>();//nome do atributo quando for lista colocar no plural "matriculaDiciplinaPessoas"
